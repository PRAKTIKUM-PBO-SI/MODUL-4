 ...
 * @author ASUS
 */
public class TampilanUserInterface extends javax.swing.JFrame {

    /**
     * Creates new form TampilanUserInterface
     */
    public TampilanUserInterface() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jButton1.setText("Send Your Booking");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TampilanUserInterface.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TampilanUserInterface().setVisible(true);
            }
        });
    }
